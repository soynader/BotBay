...
${knowledgeData.codigo_etica.prohibiciones_asesor.slice(0, 10).map(p => `- ${p}`).join('\n')}
    ...
    prompt += `\n\nIMPORTANTE PARA CÁLCULOS DE CRÉDITO:\n\n## FÓRMULA MATEMÁTICA CORRECTA (PMT):\nC = P × [i × (1+i)^n] / [(1+i)^n - 1]\n\nEsta es la fórmula estándar PMT para calcular cuotas de crédito.\n\nDonde:\n- C = cuota mensual\n- P = monto del préstamo (capital)\n- i = tasa de interés mensual en decimal (1.85% = 0.0185)\n- n = número total de meses\n\n## INSTRUCCIONES DE CÁLCULO:\n1. SIEMPRE usa la tasa de interés 1.85% N.M.V. (0.0185 en decimal)\n2. Aplica la fórmula PMT EXACTAMENTE como se muestra\n3. Redondea el resultado final a pesos colombianos (sin decimales)\n4. Muestra el cálculo paso a paso cuando sea solicitado\n5. VERIFICA siempre que el resultado coincida con el simulador oficial\n\n## EJEMPLOS DE REFERENCIA VERIFICADOS:\n\n**Ejemplo 1 (VERIFICADO CON SIMULADOR OFICIAL):**\nP = 14,000,000 COP, n = 60 meses, i = 0.0185\nC = 14,000,000 × [0.0185 × (1.0185)^60] / [(1.0185)^60 - 1]\nC = 14,000,000 × [0.0185 × 3.0348] / [3.0348 - 1]\nC = 14,000,000 × [0.0562] / [2.0348]\nC = 14,000,000 × 0.0276 = 388,258 COP ✓\n\n**Ejemplo 2:**\nP = 10,000,000 COP, n = 48 meses, i = 0.0185\nC = 295,184 COP\n\n**Ejemplo 3:**\nP = 20,000,000 COP, n = 72 meses, i = 0.0185\nC = 579,886 COP\n\n## CAPACIDAD REQUERIDA:\nDebes poder calcular CUALQUIER monto y CUALQUIER plazo que el usuario solicite usando la fórmula PMT estándar. Sé preciso y consistente con el simulador oficial.\n\nPregunta del usuario: ${question}`;
